...
def top_scam_types_data(filtered_df):
    ...
    return top_scam_type_list, top_scam_type_num_report, top_scam_total_amount_scammed_per_type


def top_scam_types_plot(df):  
    top_scam_type_list, top_scam_type_num_report, top_scam_total_amount_scammed_per_type = top_scam_types_data(df)
