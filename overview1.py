...
from utils.d1_totalreports import *
                                ...
                                if arrow == 'arrow_upward':
                                    with ui.row().classes('items-center').style(percentage_style).style('background-color: #3D1915; border-color: #3D1915'):
                                        with ui.elemyoent('div').style('margin: auto'):
                                            with ui.row():
                                                yo = ui.icon(arrow).style('margin-left: 0.4vw; margin-right: -0.5vw; margin-top: 0.4vh; color: #C14A78; font-weight: 600')
                                                yo = ui.label(f'{percentage_num}% {word}').style('color: #C14A78; letter-spacing: 0.1vw')
                                    ...
                                    with ui.row().classes('items-center').style(percentage_style).style('background-color: #117E73; border-color: #117E73'):
                                        with ui.element('div').style('margin: auto'):
                                            with ui.row():
                                                yo= ui.icon(arrow).style('margin-left: 0.4vw; margin-right: -0.5vw; margin-top: 0.4vh; color: #28E2CF; font-weight: 600')
                                                yo = ui.label(f'{percentage_num}% {word}').style('color: #28E2CF; letter-spacing: 0.1vw')
                                
                                elif arrow == 'remove':
                                    with ui.row().classes('items-center').style(percentage_style).style('background-color: #404F63; border-color: #404F63'):
                                        with ui.element('div').style('margin: auto'):
                                            with ui.row():
                                                yo = ui.icon(arrow).style('margin-left: 0.4vw; margin-right: -0.2vw; margin-top: 0.4vh; color: #CED5DF; font-weight: 600')
                                                yo = ui.label(f'0% {word}').style('color: #CED5DF; letter-spacing: 0.2vw')
